...
mongoose
  .connect(
    "mongodb+srv://siraathussein0:sir123hus@cluster0.fuhthdy.mongodb.net/",
    {
...
const sendVerificationEmail = async (email, verificationToken) => {
  ...
  const mailOptions = {
    ...
    text: `Please click the following link to verify your email: http://172.20.10.7:8081/verify/${verificationToken}`,
  };
  //send the email
  try {
...
//get orders, shown in profile screen
